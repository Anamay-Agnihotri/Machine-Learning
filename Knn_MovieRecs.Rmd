...
```{r}
Train <- read.csv(file="/Users/Anamay/Desktop/DA350/Lab6data/train_movies.csv",header=TRUE, sep=",")
Test <- read.csv(file="/Users/Anamay/Desktop/Lab6data/test_movies.csv",header=TRUE, sep=",")
```
...
```{r}
test_pred = predict(simple_fit, newdata = TestS)
summary(test_pred)
confusionMatrix(test_pred, TestS$mId1197) # doesn't really maximize accuracy; sensitivity is                                                higher
```
